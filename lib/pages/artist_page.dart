                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(TopPicks[currentIndex][0]['album'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 25)),
                            const Text("9 songs", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 20)),
                            Container(
                              padding: const EdgeInsets.all(5),
                              margin: const EdgeInsets.only(top: 5, left: 2),
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(150),
                                color: const Color.fromARGB(105, 82, 82, 82),
                              ),
                              child: const Icon(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              TopPicks[currentIndex][index]['song'],
                                              overflow: TextOverflow.ellipsis, //error
                                              style: const TextStyle(fontSize: 20),
                                            ),
                                            Text(
                                              TopPicks[currentIndex][index]['album'] + ' • 2022',
